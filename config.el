...
(setq my-blog-org-directory "~/Dropbox/blog/org-web/")
(setq my-blog-pub-directory "~/Dropbox/blog/public_html/")
;; remove validation link
(setq org-html-validation-link nil)

(setq my-pages-header-file (concat my-blog-org-directory "templates/header.html"))
(defun my-pages-header (arg)
  (with-temp-buffer
    (insert-file-contents my-pages-header-file)
    (buffer-string)))
(setq my-pages-footer-file (concat my-blog-org-directory "templates/footer.html"))
(defun my-pages-footer (arg)
  (with-temp-buffer
    (insert-file-contents my-pages-footer-file)
    (buffer-string)))
(setq my-blog-header-file (concat my-blog-org-directory "blog/templates/header.html"))
(defun my-blog-header (arg)
  (with-temp-buffer
    (insert-file-contents my-blog-header-file)
    (buffer-string)))
(setq my-blog-footer-file (concat my-blog-org-directory "blog/templates/footer.html"))
...
(setq org-publish-project-alist
      '(
       ("site" :components ("blog" "pages" "attachments"))
       ("blog"
        :recursive t
        :base-directory "~/Dropbox/blog/org-web/blog"
        :base-extension "org"
        :publishing-directory "~/Dropbox/blog/public_html/blog"
        ...
        :with-toc nil
        :section-numbers nil
        :htmlized t ;; for exporting code blocks to html
        ...
        :sitemap-title "Blog")
       ("pages"
        :base-directory "~/Dropbox/blog/org-web/"
        :base-extension "org"
        ...
        :html-preamble my-pages-header
        :html-postamble my-pages-footer)
       ...
       ("rss"
        ...
        :html-link-home "https://spool-five.com"
       ...
       ("gemini"
        :base-directory "~/Dropbox/blog/org-web/blog"
        :base-extension "org"
        :publishing-directory "~/Dropbox/blog/public_html/gemini"
        :publishing-function org-gemini-publish-to-gemini
        :auto-sitemap t
        :sitemap-sort-files anti-chronologically
        :sitemap-filename "gemini.org"
        :sitemap-title "Gemlog")))
