...
*** TODO Temporary fix for tag display and capture templates
See issue here: [[https://github.com/org-roam/org-roam/issues/1728][github issue]]
This github [[https://github.com/org-roam/org-roam/issues/1814][issue]] for capture templates
This only works if the capture templates specifiy 'target' instead of 'if-new', so I'll change them to that for now. Remeber to change them back if there is a fix...
#+begin_src emacs-lisp
